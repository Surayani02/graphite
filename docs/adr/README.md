...
| [033](./ADR-033-startup-budgets.md)            | Startup budgets: bundle gate widened to the static-import closure, always-rendered lazy islands, `sideEffects` flags, WASM budget line in capture mode |
...
Sequential, never reused. The next free number is **034**. Reserve it in
